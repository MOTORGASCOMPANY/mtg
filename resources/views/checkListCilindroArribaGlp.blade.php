    ...
    <section>
        <table style="width: 100%; border: 1px solid; border-collapse: collapse; margin: auto;">
            <tr>
                ...
                <td style="border: 1px solid; border-collapse: collapse;width: 25%;">
                    <img src="{{ $tallerauto && $tallerauto->rutaFirma ? './' . Storage::url($tallerauto->rutaFirma) : ($taller && $taller->rutaFirma ? './' . Storage::url($taller->rutaFirma) : '') }}" width="180" height="90" />{{-- {{ './' . Storage::url($taller->rutaFirma) }} --}}
                </td>
            </tr>
