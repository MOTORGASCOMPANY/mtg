<div class="max-w-5xl m-auto  bg-white rounded-lg shadow-md dark:bg-gray-300" id="datosVehiculo">
    ...
    <div class="mt-2 mb-6 px-8 py-2">
        ...
        <div class="col-span-2">
            ...
            <x-textarea class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" wire:model="modificacion.rectificacion" style="height: 200px;"/>
