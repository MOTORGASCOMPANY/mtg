<div class="bg-gray-200  px-8 py-4 rounded-xl w-full">
    <div class=" items-center md:block sm:block">
        <div class="p-2 w-64 my-4 md:w-full">
            <h4 class="text-indigo-600 font-bold text-3xl">
                <i class="fa-solid fa-person-circle-plus"></i>
                 &nbsp;Relación Talleres e Inspectores
        ...
        <div class="w-full items-center md:flex  md:justify-between">
            ...
            <div class="mb-4">
                <button  wire:click="openModal" class="bg-indigo-600 px-6 py-4 rounded-md text-white font-semibold tracking-wide cursor-pointer"> 
