...
<head>
    <title>DUPLICADO EXTERNO DE CONVERSIÓN DEL VEHÍCULO A GNV</title>
    <style>
        @page {
            margin: 0cm 0cm;
...
<body>
    ...
    <main>
        ...
        <p style="font-size:9px;">
            ...
            materia,
            según consta en el expediente técnico <strong>N°
                {{ $hoja->numSerie . ' - ' . $fechaCert->format('Y') }}</strong>,
            habilitándose al
            mismo tiempo para cargar Gas
            Licuado de Petróleo - GLP hasta el dia :
