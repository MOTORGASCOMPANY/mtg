...
<body>
    ...
    <main>
        ...
        <p>Haber efectuado la evaluación de las condiciones de seguridad respecto de la conversión del sistema de
            combustión a
        ...
        <p>
            Como consecuencia de la conversion del sistema de combustion a Gas Natural Vehicular - GNV, las
            caracteristicas originales del vehiculo
        ...
        <table>
            <tr>
                ...
                <td style="text-align:center;">
                    @if (
                            $carro->combustible === 'GASOLINA' ||
                            $carro->combustible === 'BI-COMBUSTIBLE GLP' ||
                            $carro->combustible === 'GASOLINA GLP' ||
                            $carro->combustible === 'GASOLINA-GLP' ||
                            $carro->combustible === 'GASOL/GLP')
                        BI COMBUSTIBLE GNV
        ...
        <p>Consiste por el presente documento que el sistema de combustible a Gas Natural Vehicular GNV, del vehículo
            ...
            cargar Gas Natural vehicular-GNV, hasta el:
            {{ $fechaAntiguo->format('d/m/') . ($fechaAntiguo->format('Y') + 1) }}
        </p>
        <h6>OBSERVACIONES</h6>
        <ul>
            <li>(*) Los datos de los numerales 1 al 18, provienen de la tarjeta de propiedad del vehículo y/o han sido
                suministrados por el cliente, por tal motivo deberán
                ser verificados por el cliente antes de iniciar cualquier trámite con este certificado.
            </li>
            <li>
                (**) y (***) Las condiciones técnicas y de seguridad verificadas en el vehículo, corresponden a las
                expuestas en la Resolución Directoral 3990 -2005-MTC/f5.
            </li>
            ...
            <li>Las abreviaturas: S/V significa “Sin Versión”, NE significa “No Especificado en los documentos
                presentes” </li>
            <li>Este certificado es <strong>DUPLICADO</strong> a pedido del cliente porque se le perdió y es
                <strong>COPIA FIEL DEL ORIGINAL</strong>. </li>
