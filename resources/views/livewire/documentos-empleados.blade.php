<div class="space-y-4">
                ...
                <div class="w-full bg-white">
                    <div class="flex flex-row w-full divide-x divide-gray-400/20">
                        ...
                        <div class="bg-green-100/30 w-1/2 md:w-1/3 flex justify-center space-x-2 items-center px-3">
                            ...
                            <a href="{{ route('download_docEmpleado', $doc->id) }}" rel="noopener noreferrer"
    ...
    @else
        <div class="w-full items-center mt-2 justify-center text-center py-2 ">
            <h1 class="text-xs text-gray-500 ">Aun no se ha cargado ningún documento del Empleado</h1>
        </div>
    @endif
    ...
    @if ($documento != null)
        <x-jet-dialog-modal wire:model="openEdit">
            <x-slot name="title">
                <h1 class="text-xl font-bold">Editando documento del Empleado</h1>
            </x-slot>
            <x-slot name="content">
                ...
                @if ($nuevoPdf == null)
                    <iframe width="100%" height="400" class="mt-6" src="{{ Storage::url($documento->TipoDocumento->ruta) }}" {{-- $documento->ruta --}}
            ...
            Livewire.on('deleteDocumento', documentoId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('documentos-empleados','eliminar', documentoId);
