    ...
    <div class="space-y-4">
                    ...
                    <div class="w-full bg-white">
                        <div class="flex flex-row w-full divide-x divide-gray-400/20">
                            ...
                            <div class="bg-indigo-100/30 w-1/2 md:w-1/3 flex justify-center space-x-2 items-center px-3">
                                ...
                                <a href="{{ route('download_docManual', $doc->id) }}" rel="noopener noreferrer"
        ...
        @if ($documento != null)
            <x-jet-dialog-modal wire:model="openEdit">
                <x-slot name="title">
                    <h1 class="text-xl font-bold">Editando manual</h1>
                </x-slot>
                <x-slot name="content">
                    ...
                    <div class="mb-4">
                        ...
                        <x-jet-input type="text" class="w-full" disabled
                            value="{{ $documento->tipoManual->nombreTipo }}" />
                    </div>
                    <div class="mb-4">
                ...
                Livewire.on('deleteDocumento', documentoId => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('documentos-manual','eliminar', documentoId);
