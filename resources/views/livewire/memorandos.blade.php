<div class="block justify-center mt-12 pt-8 max-h-max pb-8">
    <h1 class="text-center text-xl my-4 font-bold text-indigo-600"> REALIZAR MEMORANDO</h1>
            ...
            <div class="mb-6 px-8 py-2">
                ...
                <div class="grid grid-cols-2 gap-4 py-6">
                    ...
                    <div>
                        ...
                        <datalist id="items2">
                            <option value="INSPECTOR DE GNV">INSPECTOR DE GNV</option>
                            <option value="INSPECTOR DE GLP">INSPECTOR DE GLP</option>
                        </datalist>
